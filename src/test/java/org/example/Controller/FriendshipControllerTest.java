...
//    @Test
//    void startTrade_withNotifications() {
//        // Setup mock notifications
//        Message message1 = new Message("Alice", "Bob", "Trade from Alice");
//        Message message2 = new Message("Carol", "Bob", "Trade from Carol");
//        ArrayList<Message> notifications = new ArrayList<>();
//        notifications.add(message1);
//        notifications.add(message2);
//
//        when(currentPlayer.getTradeNotifications()).thenReturn(notifications);
//
//        // Capture System.out (optional)
...
//        assertTrue(output.contains("Trade from Alice"));
//        assertTrue(output.contains("Trade from Carol"));
//
//        // Verify the notifications were cleared and menu updated
//        verify(currentPlayer.getTradeNotifications()).clear();
//        verify(mockApp).setCurrentMenu(Menu.TradeMenu);
//
//        // Restore System.out
//        System.setOut(originalOut);
//    }
//    @Test
//    void startTrade_noNotifications() {
//        // Empty notification list
//        when(currentPlayer.getTradeNotifications()).thenReturn(new ArrayList<>());
//
//        // Capture System.out (optional)
//        PrintStream originalOut = System.out;
//        ByteArrayOutputStream outContent = new ByteArrayOutputStream();
...
//        // Check output
//        String output = outContent.toString();
//        assertTrue(output.contains("You have no trade notifications."));
//
//        // Ensure notifications cleared and menu changed
//        verify(currentPlayer.getTradeNotifications()).clear();
//        verify(mockApp).setCurrentMenu(Menu.TradeMenu);
//
//        // Restore System.out
...
//        when(t1.getX()).thenReturn(5);
//        when(t1.getY()).thenReturn(5);
//
//        assertTrue(utils.isAdjacent(t1, t1));
//    }
//
//    @Test
//    void isAdjacent_adjacentHorizontally_returnsTrue() {
//        Tile t1 = mock(Tile.class);
//        Tile t2 = mock(Tile.class);
//
//        when(t1.getX()).thenReturn(2);
//        when(t1.getY()).thenReturn(3);
//        when(t2.getX()).thenReturn(3); // 1 unit right
//        when(t2.getY()).thenReturn(3);
//
//        assertTrue(utils.isAdjacent(t1, t2));
//    }
//
//    @Test
//    void isAdjacent_adjacentVertically_returnsTrue() {
//        Tile t1 = mock(Tile.class);
//        Tile t2 = mock(Tile.class);
//
//        when(t1.getX()).thenReturn(2);
...
//        when(t2.getY()).thenReturn(2); // 1 unit up
//
//        assertTrue(utils.isAdjacent(t1, t2));
//    }
//
//    @Test
//    void isAdjacent_adjacentDiagonally_returnsTrue() {
//        Tile t1 = mock(Tile.class);
//        Tile t2 = mock(Tile.class);
//
//        when(t1.getX()).thenReturn(4);
//        when(t1.getY()).thenReturn(4);
//        when(t2.getX()).thenReturn(5);
//        when(t2.getY()).thenReturn(5); // Diagonal
//
//        assertTrue(utils.isAdjacent(t1, t2));
//    }
//
...
//        Tile t2 = mock(Tile.class);
//
//        when(t1.getX()).thenReturn(0);
//        when(t1.getY()).thenReturn(0);
//        when(t2.getX()).thenReturn(2); // too far
//        when(t2.getY()).thenReturn(0);
//
//        assertFalse(utils.isAdjacent(t1, t2));
//    }
//
//    @Test
//    void isAdjacent_farDiagonally_returnsFalse() {
//        Tile t1 = mock(Tile.class);
//        Tile t2 = mock(Tile.class);
//
//        when(t1.getX()).thenReturn(0);
//        when(t1.getY()).thenReturn(0);
//        when(t2.getX()).thenReturn(2);
//        when(t2.getY()).thenReturn(2); // 2 units diagonally
//
...
//        Backpack senderBackpack = mock(Backpack.class);
//        when(currentPlayer.getBackpack()).thenReturn(senderBackpack);
//        when(senderBackpack.getItemCount("Carrot")).thenReturn(1);
//        when(senderBackpack.grabItemAndReturn("Carrot", 1)).thenReturn(null);
//
//        Result result = controller.sendGift("Bob", "Carrot", "1");
//
//        assertFalse(result.isSuccessful());
...
//        when(currentPlayer.getBackpack()).thenReturn(senderBackpack);
//        when(senderBackpack.getItemCount("Carrot")).thenReturn(1);
//        when(senderBackpack.grabItemAndReturn("Carrot", 1)).thenReturn(item);
//        when(receiver.getBackpack()).thenReturn(receiverBackpack);
//        when(receiverBackpack.addItem(any(), eq(1))).thenReturn(new Result(false, "Inventory full"));
//
//        Result result = controller.sendGift("Bob", "Carrot", "1");
//
//        assertFalse(result.isSuccessful());
...
//    @Mock User sender;
//    @Mock User receiver;
//    @Mock Friendship friendship;
//    @Mock Backpack senderBackpack;
//    @Mock Backpack receiverBackpack;
//
//    @BeforeEach
//    void setUp() {
//        controller = new FriendshipController();
...
//        receiver = mock(User.class);
//        friendship = mock(Friendship.class);
//
//        senderBackpack = mock(Backpack.class);
//        receiverBackpack = mock(Backpack.class);
//
//        when(sender.getUsername()).thenReturn("Alice");
//        when(receiver.getUsername()).thenReturn("Bob");
//
//        when(game.getCurrentPlayer()).thenReturn(sender);
//        when(game.getPlayerByUsername("Bob")).thenReturn(receiver);
//        when(game.getFriendship("Alice", "Bob")).thenReturn(friendship);
//
//        when(sender.getBackpack()).thenReturn(senderBackpack);
//        when(receiver.getBackpack()).thenReturn(receiverBackpack);
//
//        Tile tile = mock(Tile.class);
//        when(sender.getCurrentTile()).thenReturn(tile);
//        when(receiver.getCurrentTile()).thenReturn(tile);
//        when(friendship.getLevel()).thenReturn(2); // Valid level
//    }
//
//    @Test
//    void sendGift_invalidAmount() {
//        Result result = controller.sendGift("Bob", "apple", "abc");
//        assertFalse(result.isSuccessful());
//        assertEquals("Invalid amount.", result.message());
//    }
//
//    @Test
//    void sendGift_receiverNotFound() {
//        when(game.getPlayerByUsername("Bob")).thenReturn(null);
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//        assertEquals("Receiver not found.", result.message());
//    }
//
//    @Test
//    void sendGift_friendshipNotFound() {
//        when(game.getFriendship("Alice", "Bob")).thenReturn(null);
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//        assertEquals("Friendship not found between users.", result.message());
//    }
//
//    @Test
//    void sendGift_lowFriendshipLevel() {
//        when(friendship.getLevel()).thenReturn(0);
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//        assertEquals("You don't have enough level!", result.message());
//    }
...
//    @Test
//    void sendGift_notAdjacent() {
//        when(sender.getCurrentTile()).thenReturn(mock(Tile.class));
//        when(receiver.getCurrentTile()).thenReturn(mock(Tile.class));
//        // Force non-equality
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//        assertEquals("Players are not adjacent.", result.message());
...
//
//    @Test
//    void sendGift_notEnoughItem() {
//        when(senderBackpack.getItemCount("apple")).thenReturn(1);
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//        assertEquals("Sender does not have enough of the specified item.", result.message());
//    }
...
//    @Test
//    void sendGift_grabReturnsNull() {
//        when(senderBackpack.getItemCount("apple")).thenReturn(2);
//        when(senderBackpack.grabItemAndReturn("apple", 2)).thenReturn(null);
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//    }
//
//    @Test
//    void sendGift_receiverBackpackFull() {
//        when(senderBackpack.getItemCount("apple")).thenReturn(2);
//        Item mockItem = mock(Item.class);
//        when(mockItem.getName()).thenReturn("apple");
//        when(mockItem.copy()).thenReturn(mockItem);
//        when(senderBackpack.grabItemAndReturn("apple", 2)).thenReturn(mockItem);
//
//        when(receiverBackpack.addItem(mockItem, 2)).thenReturn(new Result(false, "Receiver inventory is full!"));
//        Result result = controller.sendGift("Bob", "apple", "2");
//        assertFalse(result.isSuccessful());
//    }
//
...
//        when(mockItem.copy()).thenReturn(mockItem);
//        when(senderBackpack.grabItemAndReturn("apple", 2)).thenReturn(mockItem);
//        when(receiverBackpack.addItem(mockItem, 2)).thenReturn(new Result(true, "Added"));
//
//        Result result = controller.sendGift("Bob", "apple", "2");
//
//        assertTrue(result.isSuccessful());
//        assertEquals("Gift sent successfully. Waiting for receiver to rate the gift.", result.message());
//        verify(friendship).addToGifts(any(Gift.class));
//    }
//
//    // ==== rateGifts ====
//
/// /    @Test
/// /    void rateGifts_noGiftsReceived() {
/// /        when(receiver.getRecievedGift()).thenReturn(Collections.emptyList());
/// /
/// /        Result result = controller.rateGifts("1", "4");
/// /        assertFalse(result.isSuccessful());
/// /        assertEquals("No gifts received yet.", result.message());
...
/// /@Test
/// /void rateGifts_noGiftsReceived() {
/// /    // The current player is the one rating the gift
/// /    when(game.getCurrentPlayer()).thenReturn(sender);
/// /    when(sender.getRecievedGift()).thenReturn((ArrayList<Gift>) Collections.emptyList());
/// /
/// /    Result result = controller.rateGifts("1", "4");
/// /
/// /    assertFalse(result.isSuccessful());
...
//
//    //    @Test
////    void rateGifts_invalidRating() {
////        Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
////        when(sender.getRecievedGift()).thenReturn(Collections.singletonList(gift));
////
////        Result result = controller.rateGifts("1", "6");
////        assertFalse(result.isSuccessful());
////        assertEquals("Rating must be between 1 and 5.", result.message());
////    }
//@Test
...
//    Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
//
//    // Receiver (Bob) is the one rating the gift
//    when(game.getCurrentPlayer()).thenReturn(receiver);
//    when(receiver.getRecievedGift()).thenReturn((ArrayList<Gift>) Collections.singletonList(gift));
//
//    // Sender (Alice) exists in game
//    when(game.getPlayerByUsername("Alice")).thenReturn(sender);
//
//    // Friendship between receiver and sender
//    when(game.getFriendship("Bob", "Alice")).thenReturn(friendship);
//    when(friendship.getLevel()).thenReturn(2);
//
//    // Execute rating with an invalid rating value
//    Result result = controller.rateGifts("1", "6");
//
//    // Validate
//    assertFalse(result.isSuccessful());
...
//    void rateGifts_invalidGiftNumber() {
//        Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
//        when(sender.getRecievedGift()).thenReturn((ArrayList<Gift>) List.of(gift));
//        Result result = controller.rateGifts("2", "4");
//        assertFalse(result.isSuccessful());
//        assertEquals("No gift found with the specified gift number.", result.message());
//    }
//
//    @Test
//    void rateGifts_noFriendship() {
//        Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
//        when(sender.getRecievedGift()).thenReturn((ArrayList<Gift>) List.of(gift));
//        when(game.getPlayerByUsername("Alice")).thenReturn(mock(User.class));
//        when(game.getFriendship("Bob", "Alice")).thenReturn(null);
//        Result result = controller.rateGifts("1", "4");
//        assertFalse(result.isSuccessful());
//        assertEquals("No friendship exists between you and the sender.", result.message());
//    }
//
//    @Test
//    void rateGifts_lowFriendship() {
//        Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
//            when(sender.getRecievedGift()).thenReturn((ArrayList<Gift>) List.of(gift));
//        when(game.getPlayerByUsername("Alice")).thenReturn(mock(User.class));
//        Friendship lowLevelFriendship = mock(Friendship.class);
//        when(lowLevelFriendship.getLevel()).thenReturn(0);
//        when(game.getFriendship("Bob", "Alice")).thenReturn(lowLevelFriendship);
//
//        Result result = controller.rateGifts("1", "4");
//        assertFalse(result.isSuccessful());
//        assertEquals("You don't have enough level!", result.message());
...
//
//    @Test
//    void rateGifts_success() {
//        Gift gift = new Gift("Alice", "Bob", mock(Item.class), 1);
//        when(sender.getRecievedGift()).thenReturn((ArrayList<Gift>) List.of(gift));
//        User mockSender = mock(User.class);
//        when(mockSender.getUsername()).thenReturn("Alice");
//        when(game.getPlayerByUsername("Alice")).thenReturn(mockSender);
//
//        when(friendship.getLevel()).thenReturn(2);
//        when(game.getFriendship("Bob", "Alice")).thenReturn(friendship);
//        Result result = controller.rateGifts("1", "4");
