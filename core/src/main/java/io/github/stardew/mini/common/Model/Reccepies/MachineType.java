package io.github.stardew.mini.common.Model.Reccepies;
...
public enum MachineType {
    ...
    MYSTIC_TREE_SEED("Mystic Tree Seeds", Map.of(
    ...
    public void initTexture() {
        ...
        try {
            ...
            this.texture = new Texture("Craftable_item/" + correctedName + ".png");
        }
    }
}
