...
import io.github.stardew.mini.common.Model.ConfigTemplates.FarmTemplate;
...
import io.github.stardew.mini.common.Model.Growables.ForagingCropType;
import io.github.stardew.mini.common.Model.Growables.GrowableFactory;
import io.github.stardew.mini.common.Model.Growables.TreeType;
...
public class MapSelectionMenuController implements MenuController {
    ...
    public Message<?> pickGameMap(User player, int mapNumber, GameServer gs) {
